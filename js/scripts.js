const INCLUDE_PATH = "http://192.168.2.130/Projeto_Testes/"
...
/*
$('div.box-especialidades .icon-CSS3').click(function () {
    var especialidadesIcon = $('div.box-especialidades .icon-CSS3');
    var especialidadesShow = $('div.box-especialidades .descricao-CSS3');
    if (window.innerWidth <= 768)
        especialidadesShow.slideToggle();
    })

$('div.box-especialidades .icon-HTML5').click(function () {
    var especialidadesIcon = $('div.box-especialidades .icon-HTML5');
    var especialidadesShow = $('div.box-especialidades .descricao-HTML5');
    if (window.innerWidth <= 768)
        especialidadesShow.slideToggle();
})

$('div.box-especialidades .icon-JS').click(function () {
    var especialidadesIcon = $('div.box-especialidades .icon-JS');
    var especialidadesShow = $('div.box-especialidades .descricao-JS');
    if (window.innerWidth <= 768)
        especialidadesShow.slideToggle();
}) */
})
